...
def alpha_beta_search_aux(board, depth,
                      eval_fn,
    ...
    for move, new_board in get_next_moves_fn(board):
        val = -1 * alpha_beta_search_aux(new_board, depth-1, eval_fn,
        ...
        if depth%2 == 1 and alpha != None and best_val < alpha: #Min
            return best_val

        if depth%2 == 0 and beta != None and best_val > beta: #Max
            return best_val
...
HOW_MANY_HOURS_THIS_PSET_TOOK = "no idea"
WHAT_I_FOUND_INTERESTING = "lots of stuff"
WHAT_I_FOUND_BORING = "nothing really"
NAME = "sergio"
EMAIL = "sergiopb98@hotmail.com"
