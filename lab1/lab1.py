...
#cousin
IF( AND('parent (?x) (?y)', 'parent (?z) (?w)', 'sibling (?x) (?z)'), THEN('cousin (?w) (?y)', 'cousin (?y) (?w)') ),
#uncle
IF( AND('parent (?x) (?y)', 'male (?z)', 'sibling (?x) (?z)'), THEN('uncle (?z) (?y)') ),
#aunt
IF( AND('parent (?x) (?y)', 'female (?z)', 'sibling (?x) (?z)'), THEN('aunt (?z) (?y)') ),

#grandparent
IF( AND('parent (?x) (?y)', 'parent (?y) (?z)'), THEN('grandparent (?x) (?z)') ),
#grandfather
IF( AND('male (?x)' , 'grandparent (?x) (?y)'), THEN('grandfather (?x) (?y)') ),
#grandmother
IF( AND('female (?x)' , 'grandparent (?x) (?y)'), THEN('grandmother (?x) (?y)') ),

#grandchild
IF( 'grandparent (?x) (?y)', THEN('grandchild (?y) (?x)') ),
#grandson
IF( AND('male (?x)'    , 'grandchild (?x) (?y)'), THEN('grandson (?x) (?y)') ),
#granddaughter
IF( AND('female (?x)'  , 'grandchild (?x) (?y)'), THEN('granddaughter (?x) (?y)') )
]                    # fill me in
...
WHAT_I_FOUND_INTERESTING = 'the difficulty'
